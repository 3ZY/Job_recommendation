...
if __name__ == '__main__':
	...
	#most_popular推荐
	finallyRecommend=most_popular_finallyRecommend(Jw_SN,nowtime,lastmonth,JWINFO,JOB_OFFER,Ni,R_Num,finallyRecommend)
	most_popular_time=time.clock()
	print u"most_popular耗时: %f s" % (most_popular_time - itemCF_IUF_time)

	#CB_fill推荐
	finallyRecommend=CB_fill_finallyRecommend(Jw_SN,Job_SN,nowtime,lastmonth,JWINFO,JOB_OFFER,Ni,R_Num,finallyRecommend)
